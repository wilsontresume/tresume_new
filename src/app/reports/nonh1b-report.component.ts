...
@Component({
    ...
    templateUrl: './nonh1b-report.component.html',
    styleUrls: ['./reports.component.scss'],
    providers: [DashboardService, ReportsService]
})
export class NonH1BReportComponent implements OnInit {
    ...
    columnDefs = [
        { field: 'Sr No', sortable: true, filter: true, resizable: true },
        { field: 'Name', sortable: true, filter: true, resizable: true },
        { field: 'Legal Status', sortable: true, filter: true, resizable: true },
        { field: 'Date To Expiry', sortable: true, filter: true, resizable: true },
        { field: 'Expiry Date', sortable: true, filter: true, resizable: true }
    ];
    ...
    public getInterviews(startDate?: string, endDate?: string) {
        ...
        this.reportService.getNonH1BReport(requestItem).subscribe(x => {
