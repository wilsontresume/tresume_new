...
@Component({
    ...
    templateUrl: './jobboard-audit-report.component.html',
    styleUrls: ['./reports.component.scss'],
    providers: [DashboardService, ReportsService]
})
export class JobBoardAuditReportComponent implements OnInit {
    ...
    columnDefs = [
        { field: 'JobBoardSource', headerName: 'Job Board Source', sortable: true, filter: true, resizable: true },
        { field: 'Query', headerName: 'Search Query', sortable: true, filter: true, resizable: true },
    ...
    public getInterviews(startDate?: string, endDate?: string) {
        ...
        this.reportService.getJobBoardAuditReport(requestItem).subscribe(x => {
