...
router.post('/createtimesheetproject', async (req, res) => {
    ...
    try {
        ...
        const query = "INSERT INTO timesheet_project (projectname, clientname, netterms, status, createdby, createdate, orgid) VALUES ('"+req.body.projectname+"', '"+req.body.clientid+"', '"+req.body.netterms+"', 1, (SELECT username FROM trainee WHERE TraineeID = '"+req.body.TraineeID+"'), (SELECT CAST(GETDATE() AS DATE)), '"+req.body.orgID+"')";
